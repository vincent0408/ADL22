...
def parse_args():
    ...
    parser.add_argument(
        ...
        required=False,
        default="hfl/chinese-pert-large"
    )
    parser.add_argument(
        "--config_name",
        type=str,
    ...
    parser.add_argument("--output_dir", type=str, default="./ckpt/test/", help="Where to store the final model.")
...
def main():
    ...
    for epoch in range(starting_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(model):
                ...
                for i in range(len(start_index)):
                    train_total += 1
                    train_correct += ((start_index[i] == batch['start_positions'][i]) & (end_index[i] == batch['end_positions'][i]))
        ...
        print("Epoch {} accuracy: {}".format(epoch, train_correct/train_total))
    ...
    for step, batch in enumerate(eval_dataloader):
        with torch.no_grad():
            ...
            all_start_logits.append(accelerator.gather_for_metrics(start_logits).detach().cpu().numpy())
            all_end_logits.append(accelerator.gather_for_metrics(end_logits).detach().cpu().numpy())
